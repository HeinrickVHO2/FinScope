...
export function FinalCTASection() {
  ...
  const href = user ? `/settings?plan=premium&checkout=${checkoutMode}` : "/signup";
    ...
    <section className="bg-white py-16 text-slate-900">
      <div className="mx-auto max-w-5xl space-y-6 rounded-3xl border border-primary/10 bg-gradient-to-r from-white via-primary/5 to-white p-10 text-center shadow-sm">
        ...
        <p className="text-lg text-slate-600">
          Comece no Pro por {BILLING_PLANS.pro.priceLabel}{" "}
          ou vá de Premium por {BILLING_PLANS.premium.priceLabel}{" "}
