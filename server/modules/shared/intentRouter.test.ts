...
test("parseAssistantRouteIntent identifica meta, aporte e lembrete", () => {
  ...
  const purchaseGoalWithSavedAmount = parseAssistantRouteIntent("Quero comprar um carro de 83 mil, ja tenho 23 mil guardado");
  assert.deepEqual(purchaseGoalWithSavedAmount, {
    type: "create_goal",
    title: "carro",
    targetValue: 83000,
  ...
  const purchaseGoalWithDotThousands = parseAssistantRouteIntent("Quero juntar dinheiro para comprar um carro de 80 mil reais. Ja juntei 15.450");
  assert.deepEqual(purchaseGoalWithDotThousands, {
    type: "create_goal",
    title: "carro",
    targetValue: 80000,
    initialContribution: 15450,
  });
